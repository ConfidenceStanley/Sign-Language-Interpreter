...
import { RiMailLine, RiLockLine, RiUserLine, RiSignalTowerLine, RiArrowRightLine, RiShieldCheckLine, RiSunLine, RiMoonLine } from "react-icons/ri";
    ...
    <div className="min-h-screen bg-bg flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-between p-12 w-full">
          ...
          <div className="max-w-md">
            <h2 className="text-3xl font-bold text-txt mb-6 leading-tight">
              ...
              {benefits.map((benefit) => (
                <div key={benefit} className="flex items-center gap-3">
                  <div className="w-5 h-5 bg-indigo-600/20 rounded-full flex items-center justify-center flex-shrink-0">
                    <RiShieldCheckLine size={12} className="text-indigo-500" />
                  </div>
                  <span className="text-txt-secondary text-sm">{benefit}</span>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="flex items-center gap-4">
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm text-txt-secondary">Free to use</span>
            </div>
          </div>
        </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center px-6 py-12 relative">
        ...
        <div className="w-full max-w-[420px]">
          ...
          <div className="mb-8">
            <h1 className="text-2xl font-bold text-txt mb-2">Create your account</h1>
            <p className="text-txt-secondary text-sm">Join SignBridge and start interpreting sign language instantly</p>
          </div>
