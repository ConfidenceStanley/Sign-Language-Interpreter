const variants = {
  ...
  secondary:
    "bg-surface hover:bg-surface-hover text-txt border border-border hover:border-txt-muted",
  danger:
    "bg-red-600 hover:bg-red-500 text-white shadow-lg shadow-red-600/20",
  ghost:
    "bg-transparent hover:bg-surface text-txt-secondary hover:text-txt",
};
